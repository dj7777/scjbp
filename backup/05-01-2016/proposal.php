...
<iframe width="1000" height="760" src="pdf/Final_Jabalpur Smart City Proposal_Mygov.pdf" style="border: 5px solid black "  ></iframe>
</div>
...
$u_mob= $_GET['u_mob'];
 ...
 $tisql= "insert into ucomments(u_comm, u_name, u_email, u_mob) values('$u_comm', '$u_name', '$u_email', '$u_mob' )";
